...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 selection:bg-blue-200 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <section id="home" className="pt-24 pb-20 relative">
          {/* Hero Section Iridescence Overlay */}
                ...
                <div className="space-y-8 max-w-4xl">
                  ...
                  >
                    <div className="flex flex-col sm:flex-row gap-4 pt-6">
                      ...
                      <button className="px-8 py-4 border-2 border-blue-200 text-slate-700 rounded-xl font-medium hover:bg-blue-50 hover:border-blue-300 transition-all duration-300 backdrop-blur-sm">
                        Get In Touch
                      </button>
                    </div>
                  </AnimatedContent>
        ...
        {/* Projects Section */}
        <section id="projects" className="py-20 bg-gradient-to-br from-blue-50 to-indigo-100 relative">
          {/* Projects Section Iridescence */}
        ...
        {/* Contact Section */}
        <section id="contact" className="py-20 bg-white/50 backdrop-blur-sm relative">
          {/* Contact Section Iridescence */}
          <div className="absolute inset-0 opacity-15 z-0">
            <Iridescence />
          </div>
        ...
        <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
          ...
          {/* Decorative Elements */}
          <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-r from-blue-600/10 to-indigo-600/10 rounded-full blur-3xl -translate-x-48 -translate-y-48"></div>
          <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-r from-purple-600/10 to-pink-600/10 rounded-full blur-3xl translate-x-40 translate-y-40"></div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                ...
                <div className="lg:col-span-2">
                  ...
                  <p className="text-slate-300 leading-relaxed mb-6 max-w-md">
                    Passionate about creating innovative digital solutions through modern technology. 
                    Currently studying Software Engineering and building the future, one line of code at a time.
                  </p>
                  <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      {
                        name: "Email",
                        handle: "dhani.kusuma@example.com",
                        icon: (
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                          </svg>
                      ...
                      <a 
                        ...
                        title={social.name}
                      >
                        <div className={`w-10 h-10 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center ${social.color} transition-all duration-300 group-hover:scale-110`}>
                          {social.icon}
                        </div>
            ...
            <div className="py-8 border-t border-white/10">
              <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-slate-300 text-sm">Get notified about my latest projects and articles</p>
                </div>
                <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                  <input 
                    type="email" 
                    placeholder="Enter your email" 
                    className="px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all min-w-[250px]"
                  />
                  <button className="px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-medium hover:shadow-lg hover:scale-105 transition-all duration-300 whitespace-nowrap">
                    Subscribe
                  </button>
                </div>
              </div>
